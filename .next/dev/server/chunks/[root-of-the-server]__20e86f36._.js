...
"[project]/Documents/CSX4107_FriMorning/LMS/pages/api/books/[id].ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (r.method === 'PATCH') {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$CSX4107_FriMorning$2f$LMS$2f$models$2f$Book$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, r.body, {
            new: true
        });
    ...
    if (r.method === 'DELETE') {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$CSX4107_FriMorning$2f$LMS$2f$models$2f$Book$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, {
            status: 'deleted'
        });
        s.status(200).json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__20e86f36._.js.map