...
async function handler(req, res) {
    ...
    if (r.method === 'PATCH') {
        ...
        const body = r.body;
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$CSX4107_FriMorning$2f$LMS$2f$models$2f$Borrow$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(body.requestId, {
            status: body.status
        }, {
            new: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__90831678._.js.map